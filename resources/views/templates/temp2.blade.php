...
<html lang="en">
    <head>
        ...
        <link href="css/temp2.css" rel="stylesheet" />
    </head>
    <body id="page-top">
        <!-- Navigation-->
                ...
                <div class="row gx-0">
                    <div class="col-lg-6">
                        <a class="portfolio-item" href="#!">
                            ...
                            <img class="img-fluid" src="assets3/img/portfolio-1.jpg" alt="..." />
                        </a>
                    </div>
                    <div class="col-lg-6">
                        <a class="portfolio-item" href="#!">
                            ...
                            <img class="img-fluid" src="assets3/img/portfolio-2.jpg" alt="..." />
                        </a>
                    </div>
                    <div class="col-lg-6">
                        <a class="portfolio-item" href="#!">
                            ...
                            <img class="img-fluid" src="assets3/img/portfolio-3.jpg" alt="..." />
                        </a>
                    </div>
                    <div class="col-lg-6">
                        <a class="portfolio-item" href="#!">
                            ...
                            <img class="img-fluid" src="assets3/img/portfolio-4.jpg" alt="..." />
                        </a>
                    </div>
                </div>
            </div>
        ...
        <!-- Core theme JS-->
        <script src="js/scriptsTemp2.js"></script>
    </body>
</html>
